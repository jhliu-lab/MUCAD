...
_BACKBONES = {
    ...
    '(weights="imagenet", num_classes=1000)',
    "resnet50": "models.resnet50(weights=True)",
    "resnet101": "models.resnet101(weights=True)",
    "resnext101": "models.resnext101_32x8d(weights=True)",
    "resnet200": 'timm.create_model("resnet200", weights=True)',
    "resnest50": 'timm.create_model("resnest50d_4s2x40d", weights=True)',
    "resnetv2_50_bit": 'timm.create_model("resnetv2_50x3_bitm", weights=True)',
    "resnetv2_50_21k": 'timm.create_model("resnetv2_50x3_bitm_in21k", weights=True)',
    "resnetv2_101_bit": 'timm.create_model("resnetv2_101x3_bitm", weights=True)',
    "resnetv2_101_21k": 'timm.create_model("resnetv2_101x3_bitm_in21k", weights=True)',
    "resnetv2_152_bit": 'timm.create_model("resnetv2_152x4_bitm", weights=True)',
    "resnetv2_152_21k": 'timm.create_model("resnetv2_152x4_bitm_in21k", weights=True)',
    "resnetv2_152_384": 'timm.create_model("resnetv2_152x2_bit_teacher_384", weights=True)',
    "resnetv2_101": 'timm.create_model("resnetv2_101", weights=True)',
    "vgg11": "models.vgg11(weights=True)",
    "vgg19": "models.vgg19(weights=True)",
    "vgg19_bn": "models.vgg19_bn(pretrained=True)",
    "wideresnet50": "models.wide_resnet50_2(weights=True)",
    "wideresnet101": "models.wide_resnet101_2(weights=True)",
